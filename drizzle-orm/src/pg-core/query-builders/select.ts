...
import { SelectIterator } from '~/select-iterator.ts';
...
> extends TypedQueryBuilder<TSelectedFields, TItem, TResult> {
...
> {
	...
	iterator: ReturnType<this['prepare']>['iterator'] = () => {
		return this._prepare().iterator();
	}
}

applyMixins(PgSelectBase, [QueryPromise, SelectIterator]);
